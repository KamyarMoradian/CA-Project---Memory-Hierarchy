...
LAB46:    xsi_set_current_line(131, ng0);
    t76 = xsi_get_sim_current_time();
    t12 = xsi_vhdl_mod(((int)(t76)), 12);
    t2 = (t0 + 3168U);
    t7 = *((char **)t2);
    t2 = (t7 + 0);
    *((int *)t2) = t12;
...
LAB49:    xsi_size_not_matching(10U, t22, 0);
    goto LAB50;
...
extern void work_a_0648074530_0299855192_init()
{
	...
	xsi_register_didat("work_a_0648074530_0299855192", "isim/Processor_isim_beh.exe.sim/work/a_0648074530_0299855192.didat");
